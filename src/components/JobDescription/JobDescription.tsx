            ...
            <div className="jobdescription-box mb-4 pb-4">
              ...
              <ul className="jobdescription-list mb-0">
                <li className='d-flex align-items-center gap-1'>
                  <span>
                    <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.985 5.748a.625.625 0 0 1 0 .884l-5 5a.625.625 0 1 1-.883-.884l3.933-3.933H1.21a.625.625 0 1 1 0-1.25h11.825L9.102 1.632a.625.625 0 1 1 .883-.884z" fill="#0E4DC7" /></svg>
                  </span>
                  Lead the development of responsive, user-friendly web applications using modern front-end frameworks.</li>
                <li className='d-flex align-items-center gap-1'>
                  <span>
                    <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.985 5.748a.625.625 0 0 1 0 .884l-5 5a.625.625 0 1 1-.883-.884l3.933-3.933H1.21a.625.625 0 1 1 0-1.25h11.825L9.102 1.632a.625.625 0 1 1 .883-.884z" fill="#0E4DC7" /></svg>
                  </span>
                  Collaborate with UI/UX designers to transform designs into functional code.</li>
                <li className='d-flex align-items-center gap-1'>
                  <span>
                    <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.985 5.748a.625.625 0 0 1 0 .884l-5 5a.625.625 0 1 1-.883-.884l3.933-3.933H1.21a.625.625 0 1 1 0-1.25h11.825L9.102 1.632a.625.625 0 1 1 .883-.884z" fill="#0E4DC7" /></svg>
                  </span>
                  Optimize applications for maximum speed, scalability, and cross-browser compatibility.</li>
                <li className='d-flex align-items-center gap-1'>
                  <span>
                    <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.985 5.748a.625.625 0 0 1 0 .884l-5 5a.625.625 0 1 1-.883-.884l3.933-3.933H1.21a.625.625 0 1 1 0-1.25h11.825L9.102 1.632a.625.625 0 1 1 .883-.884z" fill="#0E4DC7" /></svg>
                  </span>
                  Write clean, maintainable, and testable code following best practices.</li>
                <li className='d-flex align-items-center gap-1'>
                  <span>
                    <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.985 5.748a.625.625 0 0 1 0 .884l-5 5a.625.625 0 1 1-.883-.884l3.933-3.933H1.21a.625.625 0 1 1 0-1.25h11.825L9.102 1.632a.625.625 0 1 1 .883-.884z" fill="#0E4DC7" /></svg>
                  </span>
                  Mentor junior developers and provide technical guidance.</li>
                <li className='d-flex align-items-center gap-1'>
                  <span>
                    <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.985 5.748a.625.625 0 0 1 0 .884l-5 5a.625.625 0 1 1-.883-.884l3.933-3.933H1.21a.625.625 0 1 1 0-1.25h11.825L9.102 1.632a.625.625 0 1 1 .883-.884z" fill="#0E4DC7" /></svg>
                  </span>
                  Stay updated on emerging technologies and propose innovative solutions.</li>
                <li className='d-flex align-items-center gap-1'>
                  <span>
                    <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.985 5.748a.625.625 0 0 1 0 .884l-5 5a.625.625 0 1 1-.883-.884l3.933-3.933H1.21a.625.625 0 1 1 0-1.25h11.825L9.102 1.632a.625.625 0 1 1 .883-.884z" fill="#0E4DC7" /></svg>
                  </span>
            ...
            <div className="jobdescription-box mb-4 pb-4">
              ...
              <ul className="jobdescription-list mb-0">
                <li className='d-flex align-items-center gap-1'>
                  ...
                  Familiarity with state management libraries (Redux, Zustand, or Recoil).</li>
                <li className='d-flex align-items-center gap-1'>
                  <span>
                    <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.985 5.748a.625.625 0 0 1 0 .884l-5 5a.625.625 0 1 1-.883-.884l3.933-3.933H1.21a.625.625 0 1 1 0-1.25h11.825L9.102 1.632a.625.625 0 1 1 .883-.884z" fill="#0E4DC7" /></svg>
                  </span>
                  Experience with testing frameworks like Jest, Cypress, or Playwright.</li>
                <li className='d-flex align-items-center gap-1'>
                  <span>
                    <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.985 5.748a.625.625 0 0 1 0 .884l-5 5a.625.625 0 1 1-.883-.884l3.933-3.933H1.21a.625.625 0 1 1 0-1.25h11.825L9.102 1.632a.625.625 0 1 1 .883-.884z" fill="#0E4DC7" /></svg>
                  </span>
                  Knowledge of design systems and component libraries.</li>
                <li className='d-flex align-items-center gap-1'>
                  <span>
                    <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.985 5.748a.625.625 0 0 1 0 .884l-5 5a.625.625 0 1 1-.883-.884l3.933-3.933H1.21a.625.625 0 1 1 0-1.25h11.825L9.102 1.632a.625.625 0 1 1 .883-.884z" fill="#0E4DC7" /></svg>
                  </span>
                  Exposure to cloud environments (AWS, GCP, or Azure).</li>
              </ul>
            </div>
            <div className="jobdescription-box" style={{ borderBottom: 'none' }}>
              ...
              <ul className="jobdescription-list mb-3">
                <li className='d-flex align-items-center gap-1'>
                  ...
                  Opportunity to work on impactful, user-facing applications.</li>
                <li className='d-flex align-items-center gap-1'>
                  <span>
                    <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.985 5.748a.625.625 0 0 1 0 .884l-5 5a.625.625 0 1 1-.883-.884l3.933-3.933H1.21a.625.625 0 1 1 0-1.25h11.825L9.102 1.632a.625.625 0 1 1 .883-.884z" fill="#0E4DC7" /></svg>
                  </span>
                  A collaborative and innovative environment.</li>
                <li className='d-flex align-items-center gap-1'>
                  <span>
                    <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.985 5.748a.625.625 0 0 1 0 .884l-5 5a.625.625 0 1 1-.883-.884l3.933-3.933H1.21a.625.625 0 1 1 0-1.25h11.825L9.102 1.632a.625.625 0 1 1 .883-.884z" fill="#0E4DC7" /></svg>
                  </span>
                ...
                <li className='d-flex align-items-center gap-1'>
                  ...
                  Remote-friendly with flexible working hours.</li>
              </ul>
