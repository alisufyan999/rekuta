  ...
  return (
    <section className="section-padding">
      <div className="container">
        <div className="rk-hero position-relative overflow-hidden rounded-4 rk-hero">
          <span className="badge rk-hero-chip">Job Listing</span>
          <h1 className="rk-hero-title text-white display-5 mb-2 text-center">Find a job that fits your future</h1>
