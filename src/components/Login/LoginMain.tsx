        ...
        <div className="container">
            ...
            <div className="loginmain-right position-relative rounded-4 p-4 p-md-5 h-100">
                ...
                <div className="col-12 col-md-6">
                    <Link
                    href="/employers" /* real route if you want; prevents nav below */
                ...
                <div className="loginmain-formcard rounded-4 p-3 p-md-4">
                    ...
                    <button type="submit" className="btn btn-primary btn-pill w-100">Login</button>

                    <div className="text-center my-3 text-muted">or</div>

                    <button type="button" className="btn loginmain-google w-100 d-flex align-items-center justify-content-center gap-2">
                        <Image src="/assets/images/login/googleicon.png" alt="Google" width={18} height={18} />
                        <span>Sign In With Google</span>
                    </button>

                    <div className="text-center small mt-3">
                        New to Rekuta? <a href="#" className="text-decoration-none">Create an account</a>
                    </div>
                    </form>
                </div>
                </div>
